...
RUN curl -fSL https://dlcdn.apache.org/spark/spark-3.5.5/spark-3.5.5-bin-hadoop3.tgz -o spark-3.5.5-bin-hadoop3.tgz \
    && tar -tzf spark-3.5.5-bin-hadoop3.tgz > /dev/null \
...
ENV GOOGLE_APPLICATION_CREDENTIALS="/opt/gcp/google_credentials.json"
...
RUN mkdir -p /opt/spark/jars && \
    ...
    wget -P /opt/spark/jars https://storage.googleapis.com/hadoop-lib/gcs/gcs-connector-hadoop3-latest.jar
